  ...
  guide: {
    ...
    notebook: {
      ...
      cells: [
        ...
        { n:'06', kind:'interp', t:'이웃 거리 k 설정', code:"t, k = 62, 3   # 슬라이스 t 를 t±k 에서 예측\n[bb[t-k], bb[t+k]]  →  bb[t]", d:'슬라이스 t 를 양옆 이웃 t±k 에서 예측합니다. [Try-it! ③]에서 k 를 sweep.' },
        ...
        { n:'08', kind:'recon', t:'B1 베이스라인 예측 & 평가', code:"rec = predict_linear_k(bb, 3)\nprint(eval_targets(rec, bb, 3))", d:'각 슬라이스를 t±k 에서 예측하고 |Δφ|·SSIM 으로 평가합니다.' },
      ],
      tryits: [
      ...
      utils: [
        ...
        { fn:'evaluate_model', group:'평가', sig:'evaluate_model(model, volume, k=3) → dict',
          ...
          params:[
            ...
            { p:'k', d:'평가 이웃 거리', try:'학습 때와 같은 k로 평가해야 공정합니다.' },
          ] },
