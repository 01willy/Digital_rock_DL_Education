...
본인이 본 W2에서 직접 확인한 것들을 본인 노트에 정리:

- UNet의 skip-connection이 어떤 역할을 한다고 본인이 이해했는가
- patch_size 를 작게 잡는 이유 — 본인의 학습 시간 경험과 함께
- 본인이 학습한 fast 모델의 |Δφ| 가 W1 baseline 보다 좋은가, 왜
- 학습 곡선이 어떻게 변했는지 (감소/평탄/진동) + 그 의미
- Cross-domain 평가에서 가장 어려웠던 도메인 + 본인 가설
